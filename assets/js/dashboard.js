async function getInvoices(userId) {
    ...
    try {
    const response = await fetch(`http://localhost:8080/api/invoices/user/${userId}`, requestOptions);
...
async function validateToken() {
    ...
    try {
    const response = await fetch("http://localhost:8080/api/user/checkToken", requestOptions);
    const result = await response.json();
