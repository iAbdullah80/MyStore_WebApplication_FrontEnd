...
<div class="items">
    <div class="product">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-8 col-md-5 product-info">
                <a class="product-name" href="../product/${parseInt(item.number, 10)}">${item.name}</a>
                <div class="product-specs">
                    <div><span>Description:&nbsp;</span><span class="value">${item.description}</span></div>
                </div>
            </div>
            <div class="col-6 col-md-2 quantity">
                <label class="form-label d-inline-block d-md-block" for="quantity">Quantity</label>
                <input type="number" id="number-1" class="form-control quantity-input" value=${item.basketCounter}>
            </div>
            <div class="col-6 col-md-2 price">
                <span>$${item.price}</span>
                <a class="btn btn-primary shadow" id="trash_button" role="button">
